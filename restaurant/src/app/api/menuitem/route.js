...
export async function GET(req) {
  ...
  // Add WHERE clause if a category is specified
...
// Optimized POST request with transaction support
...
// Optimized DELETE with faster query
...
// Optimized PUT with transaction
