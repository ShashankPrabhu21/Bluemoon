...
const ContactUs = () => {
  ...
  return (
    <div className="min-h-screen bg-blue-900 text-white">
      <div className="relative bg-white h-32 flex items-center justify-center -mt-8"></div>
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="flex flex-wrap md:flex-nowrap justify-between items-stretch mb-8">
          <div className="w-full md:w-1/2 flex justify-center items-center">
            <Image src="/R.png" alt="Left Side Image" width={300} height={300} className="rounded-lg shadow-lg object-cover h-auto" />
          </div>

          <div className="w-full md:w-[45%] text-white p-8 flex flex-col justify-center text-center">
            <h3 className="text-3xl font-bold mb-4">Need Assistance?</h3>
            <p className="text-lg font-medium">
              We’re here to help! Whether you have a question about our menu, need assistance with reservations, or want to place an order, feel free to reach out. Call or SMS us anytime—we’d love to hear from you! 😊
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-wrap md:flex-nowrap justify-center items-stretch gap-8">
          ...
          <div className="w-full md:w-[42%] bg-white text-blue-900 p-8 rounded-2xl shadow-2xl border border-gray-300">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <button type="submit" className="bg-blue-700 text-white text-base px-5 py-3 mt-2 rounded-lg hover:bg-blue-900 transition duration-200 w-full shadow-lg font-semibold">
                Submit
              </button>
          </form>
        </div>
          ...
          <div className="w-full md:w-[42%] bg-white text-blue-900 p-8 rounded-2xl shadow-2xl border border-gray-300">
            ...
            <p className="text-yellow-600 flex items-center justify-center gap-3 text-3xl font-bold mb-2">📞 0422 306 777</p>
